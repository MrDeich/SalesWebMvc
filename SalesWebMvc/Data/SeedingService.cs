...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(001, "Arthur Ramos da Silva", "arthurramos@gmail.com", new DateTime(2000, 9, 6), 8000.00, d1);
            Seller s2 = new Seller(002, "Sophia Taylor", "sophiataylor@gmail.com", new DateTime(1998, 7, 25), 4500.00, d3);
            Seller s3 = new Seller(003, "Jonny Harris", "jonnyharris@outlook.com", new DateTime(1979, 2, 18), 6000.00, d2);
            Seller s4 = new Seller(004, "Luck Miller", "luckmiller@gmail.com", new DateTime(1989, 12, 15), 5500.00, d4);
            Seller s5 = new Seller(005, "Mia Jones", "miajones@outlook.com", new DateTime(2002, 3, 9), 5000.00, d4);
            Seller s6 = new Seller(006, "Anna Brown", "annabrown@gmail.com", new DateTime(2003, 8, 30), 7000.00, d1);
